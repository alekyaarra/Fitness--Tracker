...
def weight_loss():
    ...
    my_tree['columns']=('food_pre_breakfast','food_breakfast','food_pre_lunch','food_lunch','food_post_lunch','food_snacks', 'food_dinner')

    my_tree.column("#0", width=0,  stretch=NO)
    my_tree.column("food_pre_breakfast",anchor=CENTER, width=80)
    my_tree.column("food_breakfast",anchor=CENTER, width=80)
    my_tree.column("food_pre_lunch",anchor=CENTER, width=80)
    my_tree.column("food_lunch",anchor=CENTER, width=80)
    my_tree.column("food_snacks",anchor=CENTER, width=80)
    my_tree.column("food_dinner",anchor=CENTER, width=80)
    print("a")
    my_tree.column("#0", text='', anchor=CENTER)
    my_tree.column("food_pre_breakfast",text="Pre Breakfast", anchor=CENTER, width=80)
    my_tree.column("food_breakfast",text='Breakfast', anchor=CENTER, width=80)
    my_tree.column("food_pre_lunch",text='Pre Lunch', anchor=CENTER, width=80)
    my_tree.column("food_lunch",text='Lunch', anchor=CENTER, width=80)
    my_tree.column("food_snacks",text='Snacks', anchor=CENTER, width=80)
    my_tree.column("food_dinner",text='Dinner', anchor=CENTER, width=80)
